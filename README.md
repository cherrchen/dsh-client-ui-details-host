...
The `main` branch targets **DeepSeek Harness `v0.1.2`** (including [`dsh-v0.1.2-alpha.4`](https://github.com/deepseek-ai/deepseek-harness/releases/tag/dsh-v0.1.2-alpha.4)).

For **DeepSeek Harness [`v0.1.1-rc.2`](https://github.com/deepseek-ai/deepseek-harness/releases/tag/v0.1.1-rc.2)**, use commit [`6ae54be`](https://github.com/cherrchen/dsh-client-ui-details-host/commit/6ae54be) instead.
