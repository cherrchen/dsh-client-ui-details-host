...
export type DetailsToggleProps =
  & PropsRuntime<typeof CONVERSATION_HEADER_UTILITIES_SLOT>
 ...
 */
export function DetailsToggle({ useDetailsToggle, toggleDock, t }: DetailsToggleProps) {
