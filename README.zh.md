...
本仓库的 `main` 分支面向 **DeepSeek Harness `v0.1.2`**（含 [`dsh-v0.1.2-alpha.4`](https://github.com/deepseek-ai/deepseek-harness/releases/tag/dsh-v0.1.2-alpha.4)）。

若你使用的是 **DeepSeek Harness [`v0.1.1-rc.2`](https://github.com/deepseek-ai/deepseek-harness/releases/tag/v0.1.1-rc.2)**，请改用提交 [`6ae54be`](https://github.com/cherrchen/dsh-client-ui-details-host/commit/6ae54be)。
